...
public class CaffeineListActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public static final int COARSE_LOCATION_REQUEST_CODE = 42069;
    private DBHelper db;
    ...
    //TODO: Define a new method: private void handleNewLocation(Location newLocation) that will
    //TODO: update the user's location (custom marker) on the Google Map and rebuild all markers for the Caffeine Locations
    //TODO: (standard markers)
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Log.e("Caffeine Finder", "onConnectionFailed: Connection to Location Services failed " + connectionResult.getErrorCode());
    }
